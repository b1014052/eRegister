			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="enrollment.classes.label" default="Classes" /></th>
					
						<th><g:message code="enrollment.studentEnrolled.label" default="Student Enrolled" /></th>
				...
				<g:each in="${enrollmentInstanceList}" status="i" var="enrollmentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${enrollmentInstance.id}">${fieldValue(bean: enrollmentInstance, field: "classes")}</g:link></td>
					
						<td>${fieldValue(bean: enrollmentInstance, field: "studentEnrolled")}</td>
